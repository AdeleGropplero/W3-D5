...
const me = {
  name: "Adele",
  surname: "Gropplero di Troppenburg",
  age: 26,
};
console.log("Es. C", me);
...
const splitMe = function (par) {
  arr = par.split(" ");
  // console.log(arr); Array(3) [ "ciao", "sono", "Adele" ]
  const capitalizedWord = [];
  for (let i = 0; i < arr.length; i++) {
    const Arr = arr[i].charAt(0).toUpperCase();

    const Capitalized = arr[i].slice(1);
...
console.log("Es.9", "Sono passati", howManyDays("10-18-2024"), "giorni"); //data all'americana se no mi da NaN
...
//riutilizzo l'oggetto precedentemente creato "me" e come stringa "skills"
const deleteProp = function (str, obj) {
  // delete me.skills -- ho deciso di renderlo dinamico nella riga successiva
  delete obj[str];
  return obj;
};
console.log("Es.11", deleteProp("skills", me));
